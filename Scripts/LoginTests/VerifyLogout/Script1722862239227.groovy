...
WebUI.click(findTestObject('Object Repository/AdminPage/p_Yug Shah'))

WebUI.click(findTestObject('Object Repository/AdminPage/a_Logout'))

WebUI.click(findTestObject('Object Repository/AdminPage/div_Username  AdminPassword  admin123'))
