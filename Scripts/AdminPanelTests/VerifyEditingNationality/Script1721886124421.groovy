...
WebUI.setText(findTestObject('Object Repository/Nationality/input_Password_oxd-input oxd-input--active'), 'aaaaa edited edited')

WebUI.click(findTestObject('Object Repository/Nationality/button_Save'))
