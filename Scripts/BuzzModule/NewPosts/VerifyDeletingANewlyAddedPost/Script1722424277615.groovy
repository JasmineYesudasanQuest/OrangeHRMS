...
WebUI.click(findTestObject('Object Repository/BuzzModule/p_Delete Post'))

WebUI.click(findTestObject('Object Repository/BuzzModule/button_Yes, Delete'))

WebUI.click(findTestObject('Object Repository/BuzzModule/div_SuccessSuccessfully Deleted'))
