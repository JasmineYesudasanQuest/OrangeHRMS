...
WebUI.setText(findTestObject('Object Repository/MyInfo/input_Password_oxd-input oxd-input--active'), 'jdksfhjdsfh')

WebUI.click(findTestObject('Object Repository/MyInfo/UserTypeDropDownInAddPage'))

WebUI.click(findTestObject('Object Repository/MyInfo/UserTypeDropDownInAddPage'))

WebUI.click(findTestObject('Object Repository/MyInfo/div_2'))
