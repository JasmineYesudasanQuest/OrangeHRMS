...
WebUI.doubleClick(findTestObject('Object Repository/MyInfo/a_Dependents'))

WebUI.click(findTestObject('Object Repository/MyInfo/UserTypeDropDownInAddPage'))

WebUI.click(findTestObject('Object Repository/MyInfo/button_Yes, Delete'))

WebUI.click(findTestObject('Object Repository/MyInfo/div_SuccessSuccessfully Deleted'))
