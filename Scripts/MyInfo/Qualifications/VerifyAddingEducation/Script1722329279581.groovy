...
WebUI.setText(findTestObject('Object Repository/MyInfo/input_Username_username'), 'Admin123')

WebUI.setEncryptedText(findTestObject('Object Repository/MyInfo/input_Password_password'), '9NLz+4tGZcQ=')
...
WebUI.setText(findTestObject('Object Repository/MyInfo/input_Password_oxd-input oxd-input--active'), 'jhjkhch')

WebUI.setText(findTestObject('Object Repository/MyInfo/input_Password_oxd-input oxd-input--active'), '')

WebUI.setText(findTestObject('Object Repository/MyInfo/input_Password_oxd-input oxd-input--active'), 'mszbcjsagc')

WebUI.setText(findTestObject('Object Repository/MyInfo/input_Password_oxd-input oxd-input--active'), '')

WebUI.click(findTestObject('Object Repository/MyInfo/input_Password_oxd-input oxd-input--active'))

WebUI.setText(findTestObject('Object Repository/MyInfo/input_Password_oxd-input oxd-input--active'), 's')

WebUI.setText(findTestObject('Object Repository/MyInfo/input_Password_oxd-input oxd-input--active'), '5432')

WebUI.setText(findTestObject('Object Repository/MyInfo/input_Password_oxd-input oxd-input--active'), '')

WebUI.setText(findTestObject('Object Repository/MyInfo/input_Password_oxd-input oxd-input--active'), '87')

WebUI.click(findTestObject('Object Repository/MyInfo/UserTypeDropDownInAddPage'))

WebUI.click(findTestObject('Object Repository/MyInfo/div_1'))

WebUI.click(findTestObject('Object Repository/MyInfo/UserTypeDropDownInAddPage'))

WebUI.click(findTestObject('Object Repository/MyInfo/div_9'))
