...
WebUI.click(findTestObject('Object Repository/Recruitment/a_Vacancies'))

WebUI.click(findTestObject('Object Repository/Recruitment/button_Add'))

WebUI.setText(findTestObject('Object Repository/Recruitment/input_Password_oxd-input oxd-input--active'), 'test one')
...
WebUI.click(findTestObject('Object Repository/Recruitment/div_Number of Positions'))

WebUI.click(findTestObject('Object Repository/Recruitment/button_Save'))

WebUI.click(findTestObject('Object Repository/Recruitment/div_Edit Vacancy_oxd-form-loader'))
