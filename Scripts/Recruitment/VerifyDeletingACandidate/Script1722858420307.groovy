...
WebUI.click(findTestObject('Object Repository/Recruitment/a_Recruitment'))

WebUI.click(findTestObject('Object Repository/Recruitment/button_Application Initiated_oxd-icon-butto_e2d945'))

WebUI.click(findTestObject('Object Repository/Recruitment/button_Yes, Delete'))

WebUI.click(findTestObject('Object Repository/Recruitment/UserTypeDropDownInAddPage'))

WebUI.click(findTestObject('Object Repository/Recruitment/button_Yes, Delete'))

WebUI.click(findTestObject('Object Repository/Recruitment/div_SuccessSuccessfully Deleted'))
