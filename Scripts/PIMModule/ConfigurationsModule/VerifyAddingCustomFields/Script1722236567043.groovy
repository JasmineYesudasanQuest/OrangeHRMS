...
WebUI.click(findTestObject('Object Repository/a_Custom Fields'))
...
WebUI.click(findTestObject('Object Repository/div_Screen-- Select --'))

WebUI.click(findTestObject('Object Repository/UserHintOption'))

WebUI.click(findTestObject('Object Repository/UserHintOption'))

WebUI.click(findTestObject('Object Repository/div_Text or Number'))

WebUI.click(findTestObject('Object Repository/div_TypeText or Number'))

WebUI.click(findTestObject('Object Repository/button_Save'))

WebUI.click(findTestObject('Object Repository/p_Successfully Saved'))
