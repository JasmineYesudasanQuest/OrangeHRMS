...
WebUI.doubleClick(findTestObject('Object Repository/PIM Module/input_Password_oxd-input oxd-input--active'))

WebUI.setText(findTestObject('Object Repository/PIM Module/input_Password_oxd-input oxd-input--active'), 'Admin')

WebUI.click(findTestObject('Object Repository/PIM Module/input_Password_oxd-input oxd-input--active'))
...
WebUI.click(findTestObject('Object Repository/PIM Module/span_PIM'))
...
WebUI.click(findTestObject('Object Repository/PIM Module/button_Yes, Delete'))

WebUI.click(findTestObject('Object Repository/PIM Module/p_Successfully Deleted'))
